...
<div>
    ...
    <form action="{{route('admin.pages.choose-us.update')}}" method="POST">
        @csrf
        <div class="card fadeIn mt-3">
            ...
            <div class="card-body">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group ">
                            <div class="border-custom-circle text-center custom-icon-parent bg-light shadow">
                                <h1> <i class="{{$choose_us->icon}} custom-icon-child" id="showicon"></i> </h1>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="{{ $choose_us->name }}" required>
                </div>
                <div class="form-group">
                    <label class="form-control-label">Description</label> <small class="text-danger"> * </small>
                    <textarea type="text" name="description" id="description" class="form-control description" rows="10"> {!! $choose_us->description !!} </textarea>
                </div>
            </div>
            <div class="card-footer">
                <input type="hidden" name="id" id="id" value="{{$choose_us->id}}">
