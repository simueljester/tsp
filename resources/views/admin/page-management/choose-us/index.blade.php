...
<div>
    ...
    <div class="card fadeIn mt-3">
        <div class="card-header">
            ...
            <div class="mt-3">
                <a href="{{route('admin.pages.choose-us.create')}}" class="btn btn-primary btn-sm"> </i> Add Template  </a>
            </div>
        </div>
        <div class="card-body">
                        ...
                        @forelse ($datas as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-outline-secondary btn-sm" onclick="confirmDelete({{$data->id}})">
                                        Delete
                                    </button>
                                    <form action="{{route('admin.pages.choose-us.delete')}}" method="post" id="deleteForm">
                                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <p>
                    Are you sure you want to delete this <strong> choose us template </strong> ?
                </p>
            </div>
